...
export const giraffeFacts: GiraffeFact[] = [
    ...
    { fact: "Giraffes' horn-like structures are called 'ossicones'. They consist mostly of ossified cartilage." },
    ...
    { fact: "Female giraffes have hair on their ossicones, whereas males' ossicones are bald." },
    ...
    { fact: "An adult girafffe can eat 75 lbs. of foliage per day." },
    ...
    { fact: "Giraffes allow red-billed oxpeckers (a bird species) to perch on them to feed on ticks." },
    { fact: "Egyptian heiroglyphs use the giraffe as a character, pronounced 'sr'." },
    { fact: "Designers of suits for fighter pilots studied giraffe skin, since figher pilots are also at risk of passing out when blood rushes to the legs." },
    ...
    { fact: "Kirahvi sanoo öri öri öri öri öri öri." },
